...
__conda_setup="$(CONDA_REPORT_ERRORS=false '/home/nash1111/miniconda3/bin/conda' shell.bash hook 2> /dev/null)"
if [ $? -eq 0 ]; then
    \eval "$__conda_setup"
else
    if [ -f "/home/nash1111/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/nash1111/miniconda3/etc/profile.d/conda.sh"
...
export PATH='/home/nash1111/julia-1.2.0/bin':"$PATH"
export PATH='/home/nash1111/miniconda3/bin':"$PATH"
export PATH='/home/nash1111/anaconda3/bin':"$PATH"
